// 700.fusion-webshop-claude-middle/702.cartkvstorage/nodejs/function.js
// 优化方案：方案7（消除二次JSON解析，body 直接返回对象）
// 注：本函数直接调用 DynamoDB，无跨函数 HTTP 调用，不需要方案1的 HTTP Agent
